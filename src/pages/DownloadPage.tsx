      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="relative p-[1px] rounded-[2rem] bg-gradient-emerald shadow-[0_0_40px_rgba(0,230,118,0.2)]">
          ...
          <div className="bg-bg-card rounded-[2rem] p-8 flex flex-col h-full relative z-0">
            ...
            <a 
              href="https://release-assets.githubusercontent.com/github-production-release-asset/1183978789/bcfad8b2-2cea-4940-8813-3d22da872806?sp=r&sv=2018-11-09&sr=b&spr=https&se=2026-03-19T17%3A16%3A55Z&rscd=attachment%3B+filename%3DOneClip.Hub.Setup.1.1.0.exe&rsct=application%2Foctet-stream&skoid=96c2d410-5711-43a1-aedd-ab1947aa7ab0&sktid=398a6654-997b-47e9-b12b-9515b896b4de&skt=2026-03-19T16%3A15%3A58Z&ske=2026-03-19T17%3A16%3A55Z&sks=b&skv=2018-11-09&sig=2XuPFwZuHesNDL2WJuUuBghYTHKi3UwGcGOHW4IMpaY%3D&jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmVsZWFzZS1hc3NldHMuZ2l0aHVidXNlcmNvbnRlbnQuY29tIiwia2V5Ijoia2V5MSIsImV4cCI6MTc3Mzk0MTk2MCwibmJmIjoxNzczOTM4MzYwLCJwYXRoIjoicmVsZWFzZWFzc2V0cHJvZHVjdGlvbi5ibG9iLmNvcmUud2luZG93cy5uZXQifQ.w1SpIbS9lry5SFDKTmF39XRJIpCGEPdSQW7W7mYFVwg&response-content-disposition=attachment%3B%20filename%3DOneClip.Hub.Setup.1.1.0.exe&response-content-type=application%2Foctet-stream"
